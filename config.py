...
eval_save_path = "/media/totem_backup/totem/kiven/xie_project_myself/2022.3.15/image_20x/"
data_path = '/media/totem_backup/totem/kiven/xie_project_myself/Pannuke数据集/pannuke_pkl/'
